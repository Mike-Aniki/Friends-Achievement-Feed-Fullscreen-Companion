...
This plugin exposes data via PluginSettings.
You are fully in control of layout, animations, focus, and interactions.
...
- Downloaded asynchronously (never blocks UI)
- Limited concurrency (2 downloads at a time)
- Cached locally
- Automatically updated in UI when ready

Recommended theme behavior

- Use FriendAvatarPath first
- Fallback to FriendAvatarUrl
